...
namespace Nexus
{
    public partial class App : Application
    {
        ...
        private ProcessBlockerService? _processBlockerService;
        ...
        private void OnApplicationExit(object? sender, EventArgs e)
        {
            ...
            _processBlockerService?.Stop();
            _processBlockerService?.Dispose();
        ...
        private void ShowMainView(IClassicDesktopStyleApplicationLifetime desktop, Window? closeWindow, bool registerTray, bool showWindow = true)
        {
            ...
            var mainViewModel = new MainViewModel(_configService!, _authService!, _updateService!, powerControlService, wolService, _widgetService, _scheduleService!, _toastService!, _passwordService!, _trayService);
            ...
            if (registerTray)
            {
                System.Diagnostics.Debug.WriteLine("[Nexus] 初始化系统托盘...");
                ...
                _trayService.ShowMeetingRequested += () =>
                {
                    Dispatcher.UIThread.Post(() =>
                    {
                        if (mainViewModel != null)
                        {
                            mainViewModel.SelectedNavigationItem = 0;
                        }
                        _mainView.Show();
                        _mainView.WindowState = WindowState.Normal;
                        _mainView.Activate();
                ...
                _trayService.ShowChatRequested += () =>
                {
                    Dispatcher.UIThread.Post(() =>
                    {
                        if (mainViewModel != null)
                        {
                            mainViewModel.SelectedNavigationItem = 1;
                        }
                        _mainView.Show();
                        _mainView.WindowState = WindowState.Normal;
                        _mainView.Activate();
            ...
            _processBlockerService = new ProcessBlockerService();
            _processBlockerService.Start();
            System.Diagnostics.Debug.WriteLine("[Nexus] 进程拦截服务已启动");
