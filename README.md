...
│   ├── AppConfig.cs          # 应用配置模型
│   ├── Widget/               # 小组件模型
│   │   ├── AttendanceCardModel.cs  # 考勤卡片模型
│   │   ├── WeatherCardModel.cs     # 天气卡片模型
│   │   └── ...
│   └── Attendance/           # 考勤数据模型
│       └── AttendanceModels.cs
│
...
│   ├── Widget/               # 小组件视图
│   │   ├── DesktopWidgetWindow.axaml  # 桌面小组件窗口
│   │   ├── AttendanceDetailWindow.axaml # 考勤详情窗口
│   │   └── Cards/
│   │       └── AttendanceCardView.axaml
│   └── Pages/
│       ├── DashboardPage.axaml
│       ├── SettingsPage.axaml
│       ├── UpdatePage.axaml
...
| **WebSocket实时同步** | 微信小程序提交考勤后自动更新小组件数据 |
...
| `/desktop/attendance/current` | GET | 获取当前考勤数据 |
| `/desktop/attendance/time-slots` | GET | 获取考勤时段列表 |
| `/desktop/attendance/detail` | GET | 获取考勤详情 |
